...
function Login() {
  ...
  <div className='mt-4 space-y-2'>
      ...
      <div className='relative w-80'>
        <input {...register("password", { required: true })} type={showPassword ? 'text' : 'password'} placeholder='Enter your password' className='w-full px-3 py-1 pr-12 border rounded-md outline-none dark:bg-slate-900 dark:text-white'/>
        <button type='button' onClick={() => setShowPassword(!showPassword)} className='absolute right-2 top-1/2 -translate-y-1/2 text-sm text-gray-500 dark:text-gray-300'>
