...
useEffect(()=>{
  ...
  return (
    <>
        <div className={` mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed  top-0 left-0 right-0 z-50 ${
  ...
  <div className="navbar-start ">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 dark:text-black">
     {navItems}
      </ul>
    </div>
